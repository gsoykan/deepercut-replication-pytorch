...
class DeeperCut(torch.nn.Module):
    def __init__(self, num_joints,
        ...
        self.backbone_from_conv3_to_conv5 = nn.Sequential(*resnet_modules[6:])
    ...
    def forward(self, x):
        ...
        backbone_result = self.backbone_from_conv3_to_conv5(backbone_until_conv3_result)
